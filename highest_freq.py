...
def highest_freq(file):
    """
    Uses file name as input to create a new dictionary of letter:frequencies.
    Function scrolls through each letter:frequency and finds the highest frequency.
...
if __name__ == "__main__":
    ...
    assert highest_freq("assert.txt") == ("b", 0.4)
